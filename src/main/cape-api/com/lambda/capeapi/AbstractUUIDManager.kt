...
abstract class AbstractUUIDManager(
    ...
    private fun requestProfile(nameOrUUID: String): PlayerProfile? {
        val isUUID = com.lambda.capeapi.UUIDUtils.isUUID(nameOrUUID)
    ...
    private fun requestProfileFromUUID(uuid: String): String? {
        return request("https://api.mojang.com/user/profiles/${com.lambda.capeapi.UUIDUtils.removeDashes(uuid)}/names")
    }
