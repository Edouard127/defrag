...
public abstract class SchematicFormat {
    ...
    public abstract Object readFromNBT(NBTTagCompound tagCompound);
    ...
    public static Object readFromFile(final File file) {
        try {
    ...
    public static ISchematic readFromFile(final File directory, final String filename) {
        return (ISchematic) readFromFile(new File(directory, filename));
    }
