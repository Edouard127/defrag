...
import com.defrag.client.module.modules.combat.AntiCrystal.breakDelay
import com.defrag.client.module.modules.combat.AntiCrystal.checkDelay
import com.defrag.client.module.modules.combat.AntiCrystal.minDmg
import com.defrag.client.module.modules.combat.AntiCrystal.packet
import com.defrag.client.module.modules.combat.AntiCrystal.placeDelay
import com.defrag.client.module.modules.combat.AntiCrystal.range
import com.defrag.client.module.modules.combat.AntiCrystal.rotate
import com.defrag.client.module.modules.combat.AntiCrystal.rotations
import com.defrag.client.module.modules.combat.AntiCrystal.selfDmg
import com.defrag.client.module.modules.combat.AntiCrystal.switcher
import com.defrag.client.module.modules.combat.AntiCrystal.wallsRange
import com.defrag.client.module.modules.combat.AntiCrystal.wasteAmount
import com.defrag.client.util.BlockUtil.possiblePlacePositions
import com.defrag.client.util.BlockUtil.rayTracePlaceCheck
import com.defrag.client.util.DamageUtil
import com.defrag.client.util.MathUtil.square
import com.defrag.client.util.BlockUtil.placeCrystalOnBlock
import com.defrag.client.util.MathUtil.calcAngle
...
object AntiCrystal : com.defrag.client.module.Module(
    name = "AntiCrystal",
    description = "Block enemies crystals",
    category = com.defrag.client.module.Category.COMBAT,
) {
...
operator fun Any.compareTo(toFloat: Any): Int {
