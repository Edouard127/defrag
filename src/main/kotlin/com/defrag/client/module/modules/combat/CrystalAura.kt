...
import com.defrag.client.manager.managers.HotbarManager
import com.defrag.client.manager.managers.HotbarManager.resetHotbar
import com.defrag.client.manager.managers.HotbarManager.serverSideItem
import com.defrag.client.manager.managers.HotbarManager.spoofHotbar
import com.defrag.client.manager.managers.PlayerPacketManager
import com.defrag.client.manager.managers.PlayerPacketManager.sendPlayerPacket
import com.defrag.client.mixin.extension.id
import com.defrag.client.mixin.extension.packetAction
import com.defrag.client.module.Category
import com.defrag.client.module.Module
import com.defrag.client.module.modules.combat.CombatSetting.checkEating
import com.defrag.client.util.*
import com.defrag.client.util.combat.CombatUtils.equipBestWeapon
import com.defrag.client.util.combat.CombatUtils.scaledHealth
import com.defrag.client.util.combat.CrystalUtils
import com.defrag.client.util.combat.CrystalUtils.getCrystalBB
import com.defrag.client.util.combat.CrystalUtils.getCrystalList
import com.defrag.client.util.items.*
import com.defrag.client.util.math.RotationUtils
import com.defrag.client.util.math.RotationUtils.getRotationTo
import com.defrag.client.util.math.RotationUtils.getRotationToEntity
import com.defrag.client.util.math.VectorUtils.distanceTo
import com.defrag.client.util.math.VectorUtils.toBlockPos
import com.defrag.client.util.math.VectorUtils.toVec3d
import com.defrag.client.util.math.VectorUtils.toVec3dCenter
...
import com.defrag.client.util.world.getClosestVisibleSide
