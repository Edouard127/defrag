...
object GuiColors : Module(
    ...
    private val primarySetting by setting("Primary Color", ColorHolder(100, 106, 169, 255))
    private val outlineSetting by setting("Outline Color", ColorHolder(0, 37, 193, 200))
    private val backgroundSetting by setting("Background Color", ColorHolder(0, 7, 53, 235))
    private val textSetting by setting("Text Color", ColorHolder(0, 20, 255, 255))
